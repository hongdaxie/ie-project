...
export const getHospitalImageURL = (hospitalName) =>{
    return googleSearchService.get(`v1?key=AIzaSyDpEvkpDPKBaQBuPMsou1gzbOtc77pIBUE&cx=010857273807497535145:avarjzi-g-i&q=${hospitalName}&num=1&searchType=image`)
}
