          ...
          <Layout>
            ...
            >
              ...
              >
                ...
                <ul style={{ width: "80%", margin: "0% auto 0% auto", height: "100%" }}>
                  <li
                    onClick={() =>
                  ...
                  >
                  <img src={Thiland} style={{ width: 35,marginTop: 0, height:25,borderRadius: 4, marginRight: '2%' }} />
                    {data[0].name}
                  </li>
                  <li
                    onClick={() =>
                  ...
                  >
                  <img src={UK} style={{ width: 35,marginTop: 0, height:25,borderRadius: 4, marginRight: '2%' }} />
                    {data[1].name}
                  </li>
                  <li
                    onClick={() =>
                  ...
                  >
                  <img src={China} style={{ width: 35,marginTop: 0, height:25,borderRadius: 4, marginRight: '2%' }} />
                    {data[2].name}
                  </li>
                  <li
                    onClick={() =>
                  ...
                  >
                  <img src={NewsLand} style={{ width: 35,marginTop: 0, height:25,borderRadius: 4, marginRight: '2%' }} />
                    {data[3].name}
                  </li>
                  <li
                    onClick={() =>
                  ...
                  >
                  <img src={Indonessia} style={{ width: 35,marginTop: 0, height:25,borderRadius: 4, marginRight: '2%' }} />
                    {data[4].name}
                  </li>
                  <li
                    onClick={() =>
                  ...
                  >
                   <img src={USA} style={{ width: 35,marginTop: 0, height:25,borderRadius: 4, marginRight: '2%' }} />
                    {data[5].name}
                  </li>
                </ul>
              </div>
              {selected != null ? (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div
                        style={{ width: "35%",display: 'flex', justifyContent: 'left', alignItems: 'center', textAlign: "left", height: "100%" }}
                      >
                        VACCINE RECOMMENDATIONS 
                      </div>
                      <div
                        style={{ width: "30%",display: 'flex', justifyContent: 'left', alignItems: 'center', textAlign: "left", height: "100%" }}
                      >
                        HOW DISEASE SPREADS
                      </div>
                      <div
            ...
            >
              ...
              >
                <div
                  onClick={() => this.setState({ selected: 0, selectedCountry: data[0] })}
                  style={{
                    width: "15%",
                    display: "flex",
                    backgroundColor: "#fff",
                    ...
                    flexDirection: "column",
                    backgroundImage: selected === 0? "linear-gradient(to right, rgb(5,85,255), rgb(50,115,246)": "",
                    border:"2px solid rgb(232,234,247)",
                    borderRadius: 5
                  }}
                >
                  <img src={Thiland} style={{ width: "100%", height: "50%" }} />
                  <div style={{ marginTop: "8%", height: '42%', color:selected===0?"#fff": 'rgb(5,85,255)'  }}>Thailand</div>
                </div>
                <div
                  onClick={() => this.setState({ selected: 1, selectedCountry: data[1] })}
                  style={{
                    width: "15%",
                    display: "flex",
                    backgroundColor: "#fff",
                    ...
                    flexDirection: "column",
                    border:"2px solid rgb(232,234,247)",
                    backgroundImage: selected === 1? "linear-gradient(to right, rgb(5,85,255), rgb(50,115,246)": "",
                    borderRadius: 5
                  }}
                >
                  <img src={UK} style={{ width: "100%", height: "50%" }} />
                  <div style={{ marginTop: "8%", height: '42%', color:selected===1?"#fff": 'rgb(5,85,255)'  }}>UK</div>
                </div>
                <div
                  onClick={() => this.setState({ selected: 2, selectedCountry: data[2] })}
                  style={{
                    width: "15%",
                    display: "flex",
                    backgroundColor: "#fff",
                    ...
                    flexDirection: "column",
                    border: "2px solid rgb(232,234,247)",
                    backgroundImage: selected === 2? "linear-gradient(to right, rgb(5,85,255), rgb(50,115,246)": "",
                    borderRadius: 5
                  }}
                >
                  <img src={China} style={{ width: "100%", height: "50%" }} />
                  <div style={{ marginTop: "8%", height: '42%',color:selected===2?"#fff": 'rgb(5,85,255)'  }}>China</div>
                </div>
                <div
                  onClick={() => this.setState({ selected: 3, selectedCountry: data[3] })}
                  style={{
                    width: "15%",
                    display: "flex",
                    backgroundColor: "#fff",
                    ...
                    border: "2px solid rgb(232,234,247)",
                    borderRadius: 5,
                    backgroundImage: selected === 3? "linear-gradient(to right, rgb(5,85,255), rgb(50,115,246)": ""
                  }}
                >
                  <img src={NewsLand} style={{ width: "100%", height: "50%" }} />
                  <div style={{ marginTop: "8%", height: '42%', color:selected===3?"#fff": 'rgb(5,85,255)' }}>New Zealand
    </div>
                </div>
                <div
                  onClick={() => this.setState({ selected: 4, selectedCountry: data[4] })}
                  style={{
                    width: "15%",
                    display: "flex",
                    backgroundColor: "#fff",
                    ...
                    backgroundImage: selected === 4? "linear-gradient(to right, rgb(5,85,255), rgb(50,115,246)": "",
                    border:"2px solid rgb(232,234,247)",
                    borderRadius: 5
                  }}
                >
                  <img src={Indonessia} style={{ width: "100%",marginTop: 0, height: "50%" }} />
                  <div style={{ marginTop: "8%", height: '42%', color:selected===4?"#fff": 'rgb(5,85,255)'  }}>Indonesia</div>
                </div>
                <div
                  onClick={() => this.setState({ selected: 5, selectedCountry: data[5] })}
                  style={{
                    width: "15%",
                    display: "flex",
                    backgroundColor: "#fff",
                ...
                >
                  <img src={USA} style={{ width: "100%",marginTop: 0, height: "50%" }} />
                  <div style={{ marginTop: "8%", height: '42%', color:selected===4?"#fff": 'rgb(5,85,255)'  }}>United States of America
    </div>
                </div>
              </div>
